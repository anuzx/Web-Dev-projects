...
const url = 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data='; //using API
...
//blob => binary large object , it converts the url or response data in file like object
//blobs are particularly useful for working with file data wothout needing to save it on a server
